...
<head>
	<title>Logando</title>
	<meta charset="utf-8"/>
	<link rel="stylesheet" href="estilo_autenticacao_sites.css"/>
...
<script>
	...
	{
		setTimeout("window.location='selecionar_quiz_programacao_e_outros_sites.php'", 3000);
	}
	
	function loginfailed()
	{
		setTimeout("window.location='login_selecionar_quiz_programacao_e_outros_sites.html'", 3000);
	}
</script>
</head>
<body>
