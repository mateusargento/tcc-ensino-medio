...
<head>
	<title>Logando</title>
	<meta charset="utf-8"/>
	<link rel="stylesheet" href="estilo_autenticacao_design.css"/>
...
<script>
	...
	{
		setTimeout("window.location='selecionar_quiz_design.php'", 3000);
	}
	
	function loginfailed()
	{
		setTimeout("window.location='login_selecionar_quiz_design.html'", 3000);
	}
</script>
</head>
<body>
