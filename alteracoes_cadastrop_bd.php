...
$linkcurriculolattes=$_POST['linkcurriculolattes'];
$senha=$_POST['senha'];
...
mysql_query("UPDATE cadastro_do_profissional SET nome = '$nome', sobrenome = '$sobrenome', email = '$email', cpf = '$cpf', rg = '$rg', endereco = '$endereco', numerodacasa = '$numerodacasa', complemento = '$complemento', bairro = '$bairro', cidade = '$cidade', uf = '$uf', cep = '$cep', telefone = '$telefone', celular = '$celular', datadenascimento = '$datadenascimento', profissao = '$profissao', $linkcurriculolattes = '$linkcurriculolattes', senha = MD5('$senha'), confirmesenha = MD5('$confirmesenha'), sexo = '$sexo', descricao = '$descricao' WHERE email = '$email' ");
...
mysql_query("UPDATE usuario SET email = '$email', senha = MD5('$senha') WHERE email = '$email' ");
