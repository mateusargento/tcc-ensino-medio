...
<head>
	<meta charset="utf-8"/>
	<title> </title>
	<link rel="stylesheet" href="estilo_cdc.css"/>
...
<fieldset><legend id="sexo">Número de parcelas:</legend>
	...
	<input type="text" value="<?php echo $pergunta_1; ?>" style="display: none">
	<input type="text" value="<?php echo $pergunta_2; ?>" style="display: none">
	<input type="text" value="<?php echo $pergunta_3; ?>" style="display: none">
	<input type="text" value="<?php echo $pergunta_4; ?>" style="display: none">
	<input type="text" value="<?php echo $pergunta_5; ?>" style="display: none">
	<input type="text" value="<?php echo $descricao; ?>" style="display: none">
