...
{
	header("Location: login_selecionar_quiz_programacao_e_outros_aplicativos.html"); // Redirecionar para a pagina de login
...
<head>
	<meta charset="utf-8"/>
	<title> </title>
	<link rel="stylesheet" href="estilo_selecionar_quiz_programacao_e_outros_aplicativos.css"/>
...
<h1><center>Aplicativos:</center></h1>
<section id="fieldset">
<h1></h1>

<img src="imagens/aplicativos_loja.png" id="design_loja">
...
<form method="post" action="compras_aplicativos.php">
...
<fieldset id="tiposdeservico"><legend>Número de parcelas:</legend>
	  <select name="parcelas"> <!-- Selecionar opções -->
		...
		<option>3 sem juros</option> <!-- Opção -->
	  </select>	
</fieldset>
