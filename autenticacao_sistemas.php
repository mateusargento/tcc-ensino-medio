...
<head>
	<title>Logando</title>
	<meta charset="utf-8"/>
	<link rel="stylesheet" href="estilo_autenticacao_sistemas.css"/>
...
<script>
	...
	{
		setTimeout("window.location='selecionar_quiz_programacao_e_outros_sistemas.php'", 3000);
	}
	
	function loginfailed()
	{
		setTimeout("window.location='login_selecionar_quiz_programacao_e_outros_sistemas.html'", 3000);
	}
</script>
</head>
<body>
