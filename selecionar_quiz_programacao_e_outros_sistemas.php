...
{
	header("Location: login_selecionar_quiz_programacao_e_outros_sistemas.html"); // Redirecionar para a pagina de login
...
<head>
	<meta charset="utf-8"/>
	<title> </title>
	<link rel="stylesheet" href="estilo_selecionar_quiz_programacao_e_outros_sistemas.css"/>
...
<h1><center>Sistemas:</center></h1>
<section id="fieldset">
<h1></h1>

<img src="imagens/sistemas_loja.png" id="design_loja">
...
<form method="post" action="compras_sistemas.php">
...
<fieldset id="tiposdeservico"><legend>Número de parcelas:</legend>
	  <select name="numero_de_parcelas"> <!-- Selecionar opções -->
