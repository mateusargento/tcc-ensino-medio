...
<head>
	...
	<meta charset="utf-8"/>
	<link rel="stylesheet" href="estilo_compras_sites.css"/>
	<link rel="shortcut icon" href="favicon.png"/>
<script>

	function voltar() // Fazer o link
	{
		window.location.href = "selecionar_quiz_programacao_e_outros_sites.php";
	}
...
mysql_query("INSERT INTO compras_sites(sobre, sobre_outro, seria, tempo, informacoes, nome_do_cartao, numero_do_cartao, data_de_validade, codigo_de_seguranca, parcelas, email, valtotal, bandeira_do_cartao, status)
VALUES('$sobre', '$sobre_outro', '$seria', '$tempo', '$informacoes', '$nome_do_cartao', '$numero_do_cartao', '$data_de_validade', '$codigo_de_seguranca', '$parcelas', '$email', '$valtotal', '$bandeira_do_cartao', '$status')");
