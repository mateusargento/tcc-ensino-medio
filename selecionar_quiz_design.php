...
{
	header("Location: login_selecionar_quiz_design.html"); // Redirecionar para a pagina de login
...
<head>
	<meta charset="utf-8"/>
	<title> </title>
	<link rel="stylesheet" href="estilo_selecionar_quiz_design.css"/>
...
<img src="imagens/design_loja.png" id="design_loja">
...
<h3 id="total">R$: 150,00</h3> <br>
<h4 id="valorparcelado2"></h4>
<h4 id="valorparcelado3"></h4>

<form method="post" action="compras_design.php">
	...
	<textarea name="informacoes" cols="45" rows="5" placeholder="Descreva aqui detalhes que deseja citar." required ></textarea> <!-- Campo para descrever conhecimento profissional -->
	</fieldset> <br>

<fieldset id="tiposdeservico"><legend>Dados para finalização da compra</legend>
	<input type="text" name="nome_do_cartao" placeholder="Nome completo conforme no cartão de crédito" maxlength="255" required /> <br> <!-- Campo para informar o nome com no máximo 255 caracteres obrigatório -->
	<input type="text" name="numero_do_cartao" placeholder="Número do cartão" maxlength="255" required id="numerodocartao" required /> <br> <!-- Campo para informar o nome com no máximo 255 caracteres obrigatório -->
	<input type="text" name="bandeiradocartao" placeholder="Bandeira do cartão" maxlength="255" required /> <br> <!-- Campo para informar o nome com no máximo 255 caracteres obrigatório -->
	<input type="text" name="data_de_validade" placeholder="Data de Validade" maxlength="7" required id="datadevalidade" required /> <br> <!-- Campo para informar data de validade com no máximo 7 dígitos obrigatório -->
...
<fieldset id="tiposdeservico"><legend>Número de parcelas:</legend>
	  <select name="parcelas" required> <!-- Selecionar opções -->
...
<input type="text" name="email" placeholder="email" value="Em andamento" maxlength="255" style="display: none" required /> <br><br> <!-- Campo para informar o Código de Segurança como no máximo 255 caracteres obrigatório -->

<input type="submit" value="Contratar serviço agora" id="submit"/> <br><br>
</form>
</section>
<!----------------------------------------------------------->
