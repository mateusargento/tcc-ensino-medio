...
<head>
	...
	<meta charset="utf-8"/>
	<link rel="stylesheet" href="estilo_cadastrop_bd.css"/>
	<link rel="shortcut icon" href="favicon.png"/>
<script>
	function falhacadastro()
	{
		setTimeout("window.location='cadastro_profissional.html'", 3000);
	}
...
{
mysql_query("INSERT INTO cadastro_do_profissional(nome, sobrenome, email, cpf, rg, endereco, numerodacasa, complemento, bairro, cidade, uf, cep, telefone, celular, datadenascimento, senha, confirmesenha, sexo)
